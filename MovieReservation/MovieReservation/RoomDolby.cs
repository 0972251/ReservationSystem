...
{
    public partial class RoomDolby : Form
    {
        ...
        public RoomDolby(int amountSeats, List<string> reservedSeats)
        {
            InitializeComponent();
        ...
        {
            TicketConfrim ticket = new TicketConfrim("Dolby", AmountSeats, Seats, ReservedSeats, 7);
            this.Hide();
            ticket.ShowDialog();
            this.Close();
        }
